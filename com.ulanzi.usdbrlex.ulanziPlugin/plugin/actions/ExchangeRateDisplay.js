...
function ExchangeRateDisplay(ctx) {
    var context = ctx,
        ...
        lastUpdate = null,
        refreshTimer = 0,
        refreshInterval = 60, // Default 60 minutes (1 hour)
    ...
    function isDataStale(timestamp) {
        ...
        // 2. It's older than 3 hours (absolute maximum for hourly updates)
        // 3. We're offline and data is older than 5 minutes
        const maxAge = Math.min(staleThreshold, 3 * 60 * 60 * 1000); // Max 3 hours
